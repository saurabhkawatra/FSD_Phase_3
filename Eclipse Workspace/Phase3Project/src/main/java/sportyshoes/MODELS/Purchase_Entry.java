...
public class Purchase_Entry {
	...
	public Purchase_Entry(int purchase_entry_id, int purchased_productid, int purchased_By_userid, Date purchased_Date) {
		super();
	...
	public String toString() {
		return "PurchaseEntry is [purchase_entry_id=" + purchase_entry_id + ", purchased_productid=" + purchased_productid
				+ ", purchasedBy_userid=" + purchased_By_userid + ", purchasedDate=" + purchased_Date + "]";
	}
